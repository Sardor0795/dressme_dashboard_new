        ...
        <div className="w-full h-fit px-2 md:px-0">
          ...
          <div className="w-full md:w-[484px] flex justify-between items-center box-border bg-[#f7f7f7] rounded-lg mx-auto mb-[30px] ">
            ...
            >
              ...
              />
              <span className="ml-[4px] md:ml-2">{t("personUser")}</span>
            </button>
            <button
            ...
            >
              <DashboardList
                className={`${naturalPerson ? "text-fullBlue" : ""}`}
              />
              <span className="ml-[4px] md:ml-2 whitespace-nowrap	">
                {t("companyUser")}
              </span>
            </button>
          </div>
                      ...
                      <div key={data?.id}>
                        <div className="flex items-center">
                          <input
                            ...
                            checked={
                              parseFloat(data?.id) ===
                              parseFloat(state?.seller_type_id)
                            }
                            className="w-[18px] h-[18px] cursor-pointer"
                            onChange={(e) =>
                              setState({
                                ...state,
                                seller_type_id: e.target.value,
                              })
                            }
                            required
                          />
                                      ...
                                      >
                                        ...
                                        >
                                          <input
                                            ...
                                            required
                                          />
                                          <span className="text-[#303030] md:text-base cursor-pointer text-[15px] not-italic font-AeonikProRegular">
                            ...
                            .map((item) => {
                              return (
                                ...
                                >
                                  {item?.name_ru},
                                  {item?.sub_regions
                                    ?.filter((i) => i.id == state?.sub_region)
                                    .map((item) => {
                                      return (
                ...
                <div className="w-full  xs:flex-row flex-col flex items-center justify-between gap-x-5 sm:gap-x-[50px] gap-y-4 xs:gap-y-0">
                  <div className="w-full xs:w-1/2 h-fit ">
                    ...
                    <div className="mt-1 xs:mt-[6px]  w-full flex items-center overflow-hidden border border-searchBgColor rounded-lg ">
                      <input
                        className="w-full px-2 xs:px-[16px] outline-none	bg-white h-[42px]  placeholder-leading-4 placeholder-tracking-[0,16px] placeholder-not-italic placeholder-font-AeonikProRegular ll:text-[14px] sm:text-[16px] placeholder-text-[14px] placeholder-leading-4 placeholder-text-black"
                        type="text"
                        name="fname"
                        autoComplete="off"
                        placeholder={t("name")}
                  ...
                  <div className="w-full xs:w-1/2 h-fit ">
                    ...
                    <div className="mt-1 xs:mt-[6px]  w-full flex items-center  overflow-hidden border border-searchBgColor rounded-lg ">
                      <input
                        className="w-full px-2 xs:px-[16px] outline-none	bg-white placeholder-bg-white h-[42px]  placeholder-leading-4 placeholder-tracking-[0,16px] placeholder-not-italic placeholder-font-AeonikProRegular ll:text-[14px] sm:text-[16px] placeholder-text-[14px] placeholder-leading-4 placeholder-text-black"
                        type="text"
                        name="lname"
                        autoComplete="off"
                  ...
                  <div className="w-full xs:w-1/2 h-fit">
                    ...
                    <div className="mt-[6px] flex items-center overflow-hidden border border-searchBgColor rounded-lg">
                      <div className="w-[30%] sm:w-[35%] md:w-[100px] h-[40px] xs:h-[42px] flex items-center justify-center   cursor-pointer border-r border-searchBgColor overflow-hidden">
                        <div className=" outline-none flex items-center	w-[40px] h-[42px]  placeholder-leading-4 placeholder-tracking-[0,16px] placeholder-not-italic placeholder-font-AeonikProRegular ll:text-[14px] sm:text-[16px] placeholder-text-[14px] placeholder-leading-4 placeholder-text-black">
                          {state.phoneCode}
                        </div>
                      </div>
                      ...
                      <span className="cursor-pointer w-[48px] h-[42px] flex items-center  ">
                        {state?.confirmPasswordEye ? (
                          <span
                            className="w-full h-full  flex items-center justify-center"
                            onClick={() =>
                              setState({ ...state, confirmPasswordEye: false })
                            }
                          >
                            <AiOutlineEye size={20} color={"#e2e2e2"} />
                          </span>
                          ...
                          <span
                            className="w-full h-full  flex items-center justify-center"
                            onClick={() =>
                              setState({ ...state, confirmPasswordEye: true })
                            }
                          >
                            <AiOutlineEyeInvisible
                              size={20}
          ...
          <div className="flex items-center justify-center flex-col mt-[30px] xs:mt-[50px] md:mt-[90px]  mb-[88px] md:mb-8">
            <button
              type="button"
              onClick={onSubmit}
              className="w-full md:w-[360px] select-none h-12 flex items-center justify-center mx-auto font-medium bg-fullBlue text-base text-white rounded-xl active:scale-95"
            >
              {t("set")}
            </button>
            <NavLink
              to="/login-seller"
              className={
                "mt-[15px] text-fullBlue hover:underline select-none  text-base not-italic font-AeonikProRegular"
              }
            >
              {t("hasAccount")}
            </NavLink>
