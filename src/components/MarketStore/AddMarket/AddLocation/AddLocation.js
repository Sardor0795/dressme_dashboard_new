  ...
  return (
    <div className="w-full max-w-[920px] mx-auto mt-6 md:mt-12">
      ...
      <div className=" border border-red-500">
        ...
        <div className="flex mt-[10px] justify-between items-centers gap-x-[5px] ls:gap-x-[10px] md:gap-[25px] mb-[25px] border border-red-500">
          <div className=" w-full h-[75px] md:h-[130px] border-2 border-dashed flex items-center justify-center rounded-lg">
        ...
        <div className="flex flex-wrap items-center w-full  gap-x-[5px] ls:gap-x-[10px] md:gap-[25px] mb-[25px]">
          <label className="w-full flex flex-col border border-green-500">
            <div className="w-full text-base flex items-center mb-[10px]">
              Имя администратора{" "}
