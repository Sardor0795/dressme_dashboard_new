  ...
  return (
    <div className="w-full h-full px-4 md:px-10 py-1">
      ...
      <div className="h-fit py-7 w-full flex items-center justify-end">
        <button className="w-fit h-[42px] active:scale-95 rounded-lg flex items-center px-[12px] bg-weatherWinterColor text-white text-base not-italic font-AeonikProMedium">
