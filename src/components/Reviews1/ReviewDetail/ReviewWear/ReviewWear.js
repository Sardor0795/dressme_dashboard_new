    ...
    () => fetchData(customHeaders),
    {
      onSuccess: (data) => {
        if (data?.status >= 200 && data?.status < 300) {
          setDressInfo({
            ...dressInfo,
            getReviewProduct: data?.data?.products,
          });
        }
      },
      onError: (error) => {
                          ...
                          <div key={index} className="w-full   mb-[60px]">
                            ...
                            <div className="relative w-full max-w-[440px] mb-[20px] md:hidden gap-x-5 flex items-center h-[90px] border border-lightBorderColor rounded-lg p-2">
                              <div className="w-[80px] h-[75px]">
                                <img
                                  src={data?.photos[0]?.url_photo || "nodate"}
                                  alt={"noImg"}
                              ...
                              <div className="w-fit flex items-center h-full  ">
                                <div className="w-full flex flex-col h-fit gap-y-1">
                                  <div className="h-fit flex items-center gap-x-[10px]">
                                    <p className="text-[13px] font-AeonikProMedium">
                                      {t("name_product")}
                                    </p>
                                  ...
                                  <div className="h-fit flex items-center gap-x-[10px]  ">
                                    ...
                                    <p className="text-textLightColor  text-[11px]  leading-4 font-AeonikProMedium">
                                      {data?.created_at}
                                    </p>
                                  </div>
                                </div>
