...
function UnderAddWear({ title, typeId }) {
    ...
    }, [typeId])    // Underwear bor Цена
    // console.log(dressInfo?.ProductFilterType, "ProductFilterType - underWear");
    ...
    return (
        <Popover
            ...
            options={["Hide"]}
            placement="bottom"
            content={dressInfo?.ProductFilterType ? dressInfo?.ProductFilterType == SelectedNumber ? contentUnderWear : null : contentUnderWear}
