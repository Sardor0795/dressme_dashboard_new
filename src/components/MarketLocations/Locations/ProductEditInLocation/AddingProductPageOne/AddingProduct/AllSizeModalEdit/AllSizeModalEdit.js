...
function AllSizeModalEdit({ onClick, modalOpenColor, colorGroup }) {
  ...
  // green
  return (
    <div className="w-full md:w-[670px] h-fit bg-white rounded-lg bg-white md:py-5 px-2 ls:px-3 ll:px-5 py-[6px] ls:py-2 ll:py-[10px] md:px-4 border border-green-500">
      ...
      {/* All Cards */}
      <div className="h-[694px] overflow-auto flex flex-col gap-y-2 mt-4 md:mt-6 AllSizeModalScroll">
        {/* Cards */}
        <div className="w-full flex items-center gap-x-[6px]  ">
          ...
          <div className="w-full ">
            ...
            <div className="w-full border md:border border-red-500  rounded-lg md:p-3 pb-4">
              {/* <div className="w-full border-t md:border border-borderColor  rounded-lg md:p-3 pb-4"> */}

              {/* For Price Mobile*/}
              <div className="w-full flex  md:hidden gap-x-1 ls:gap-x-[10px]  border border-blue-600 ">

                <div className="w-fit flex flex-col border border-red-500">
                  ...
                  <label className="w-[95px] xs:w-[120px]  flex h-[38px] border border-borderColor rounded-lg overflow-hidden flex items-center">
                    <input
                      type="text"
                      placeholder="Цена"
                      value={"1300000"}
                  ...
                  <div className="flex items-center">
                    <div className="flex flex-col">
                      <input
                        type="text"
                        value={"13 %"}
                        className="w-[40px] xs:w-[60px] h-[38px] border border-borderColor pl-1 xs:pl-2  rounded-lg text-[14px]  font-AeonikProRegular  outline-none"
                        placeholder=""
                      />
                    </div>
                    ...
                    <label className="w-[95px] xs:w-[120px]  flex h-[38px] rounded-lg overflow-hidden border border-borderColor flex items-center">
                      <input
                        type="text"
                        value="1 300 000"
              ...
              {/* For size */}
              <div
                className={`w-full h-fit flex md:flex-row flex-col mt-[15px] md:mt-0 border border-blue-600 justify-between not-italic cursor-pointer font-AeonikProMedium text-md leading-4 text-center `}
              >
                <div className="w-full md:w-1/2 flex flex-wrap justify-between gap-[15px] ll:gap-6 border border-black">
                  ...
                  <div className="w-[45%] flex flex-col ">
                    ...
                    <div className="flex items-center">
                      <div className="flex flex-col">
                        <input
                          type="text"
                          className="w-[50px] ll:w-[60px] ll:w-[60px] text-center h-[38px] border border-borderColor px-3 py-[10px] rounded-lg text-xs  font-AeonikProRegular [&::-webkit-inner-spin-button]:appearance-none outline-none"
                          placeholder="Мин"
                          value={"18"}
                        />
                      </div>
                  ...
                  <div className="w-[45%] flex flex-col ">
                    ...
                    <div className="flex items-center">
                      ...
                      <div className="flex flex-col">
                        <input
                          type="text"
                          className="w-[50px] ll:w-[60px] h-[38px] text-center border border-borderColor px-3 py-[10px] rounded-lg text-xs font-AeonikProRegular [&::-webkit-inner-spin-button]:appearance-none outline-none"
                ...
                <div className="w-full md:w-[47%] flex flex-col gap-y-[10px] border border-black md:mt-0 mt-[15px] ">
                  <div className="w-full">
                    <p className="flex items-center text-[14px] ll:text-base text-mobileTextColor mb-2 ll:mb-[10px] ll:font-AeonikProMedium font-AeonikProRegular">
                      Буквенный Размер
                      <span className="ml-[5px]">
                  ...
                  <div className="w-full flex flex-col items-center md:hidden  border border-blue-600">
                    ...
                    <div className="flex items-center w-full justify-between">
                      <button className="w-[90px] ll:w-[120px] h-[38px] bg-lightBgColor border border-borderColor rounded-lg flex items-center justify-center text-black text-2xl active:scale-95  active:opacity-70 not-italic font-AeonikProMedium">-</button>
                      <button className="w-[40px] ll:w-[60px] h-[38px] border border-borderColor rounded-lg flex items-center justify-center text-black text-base not-italic font-AeonikProMedium">2</button>
                      <button className="w-[90px] ll:w-[120px] h-[38px]  bg-lightBgColor border border-borderColor rounded-lg flex items-center justify-center text-black text-2xl  not-italic font-AeonikProMedium">+</button>
                    </div>
                  </div>
                </div>
              </div>
              {/* For Price Desktop*/}
              <div className="w-full flex gap-x-5  border border-blue-600 mt-[15px]">
              ...
              <div className="flex items-center justify-between  border border-blue-600 mt-5">
                {" "}
