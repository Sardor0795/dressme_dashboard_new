  ...
  return (
    <div className=" w-[100%] h-[90vh] mx-auto bg-white shadow-navMenuShadov  p-4   overflow-hidden  rounded-t-[12px]">
      ...
      <div className="flex items-center justify-between mt-4">
        ...
        {/* <button className="h-8 ll:h-[35px] flex items-center justify-center px-1 ll:px-[10px] text-textBlueColor focus:text-white border border-textBlueColor focus:bg-textBlueColor bg-white rounded-lg text-[10px] ls:text-[12px] ll:text-xs not-italic font-AeonikProMedium">Все размеры</button> */}
        {/* <button className="h-8 ll:h-[35px] flex items-center justify-center px-1 ll:px-[10px] text-textBlueColor focus:text-white border border-textBlueColor focus:bg-textBlueColor bg-white rounded-lg text-[10px] ls:text-[12px] ll:text-xs not-italic font-AeonikProMedium">Добавить размер</button> */}
      </div>
      {/* <div className="w-full h-[70%] overflow-auto AllSizeModalScroll flex flex-col flex-nowrap rounded-lg border border-borderColor mt-6">
